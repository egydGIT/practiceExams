...
class DaVinciCodeTest {
    ...
    void test_encode_zero_emptyInputWithX() throws IOException {
        String input = "src/test/resources/finalExamRetake02/countchars/input1.txt";
    ...
    void test_encode_zero_inputWithoutXCharToFindX() throws IOException {
        String input = "src/test/resources/finalExamRetake02/countchars/input2.txt";
    ...
    void test_encode_one_inputWithOne1CharToFindOne() throws IOException {
        String input = "src/test/resources/finalExamRetake02/countchars/input3.txt";
    ...
    void test_encode_five_input012345x0x0ertz0fx0() throws IOException {
        String input = "src/test/resources/finalExamRetake02/countchars/input4.txt";
    ...
    void test_encode_four_inputInMoreLinesWithFourX() throws IOException {
        String input = "src/test/resources/finalExamRetake02/countchars/input5.txt";
